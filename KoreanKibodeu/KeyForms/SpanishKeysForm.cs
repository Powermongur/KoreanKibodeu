...
{
    public partial class SpanishKeysForm : Form
    {
        public SpanishKeysForm()
        {
            InitializeComponent();
        }
        ...
        private void SpanishKeysForm_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < Controls.Count; i++)
            {
                if (Controls[i].TabIndex >= 1000)
                    Controls[i].MouseDown += new System.Windows.Forms.MouseEventHandler(SpanishKeysForm_MouseDown);
            }
        }

        private void SpanishKeysForm_MouseDown(object sender, MouseEventArgs e)
        {
