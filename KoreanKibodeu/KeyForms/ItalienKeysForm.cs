...
{
    public partial class ItalienKeysForm : Form
    {
        public ItalienKeysForm()
        {
            InitializeComponent();
        }
        ...
        private void ItalienKeysForm_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < Controls.Count; i++)
            {
                if (Controls[i].TabIndex >= 1000)
                    Controls[i].MouseDown += new System.Windows.Forms.MouseEventHandler(ItalienKeysForm_MouseDown);
            }
        }

        private void ItalienKeysForm_MouseDown(object sender, MouseEventArgs e)
        {
